...
-   [Clang latest version documentation](https://clang.llvm.org/docs/index.html) (Usually for the latest version)
    ...
    -   [Clang 16.0.0 version](https://releases.llvm.org/16.0.0/tools/clang/docs/index.html) (cce/16.0.0 in 23.09)

-   [AMD Developer Information](https://www.amd.com/en/developer.html). Note that AMD doesn't archive
    manuals of older versions which can be a problem. You have to reprocess them from GitHub repositories.
    ...
    -    [AOCC 4.0 CompilerOptions Quick Reference Guide](https://www.amd.com/content/dam/amd/en/documents/developer/compiler-options-quick-ref-guide-amd-epyc-9xx4-series-processors.pdf)
         (Version 4.0 compilers will come when the 23.05 or later CPE release gets installed on LUMI and the system
         is updated to COS 2.5 as some libraries are missing in COS 2.4)
...
??? Note "AMD documentation"

    AMD doesn't archive documentation for past versions of ROCM and their CPU compilers in a way
    that is ready-to-read. Instead 
